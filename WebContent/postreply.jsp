	...
	<body>
		...
		<DIV class="t" style="MARGIN-TOP: 15px" align="center">
			...
			<center>
				回复帖子
				<hr width=80% />
				<FORM action="${pageContext.request.contextPath }/topic.s?op=postreply" method="post" id="form">
					...
					<br />
					内容: 
					<textarea id="content" name="content" value=""  rows="10" cols="80" >
		             	${param.content }
		            </textarea>
					<br />
